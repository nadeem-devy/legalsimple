...
function NvDivorceWithChildrenChatContent() {
    ...
    <div className="max-w-5xl mx-auto py-4">
      ...
      <div className="text-center mb-4">
        ...
        <p className="text-slate-600 max-w-lg mx-auto text-sm">
          Complete this questionnaire to prepare your Nevada Complaint for Divorce and UCCJEA Declaration with custody, child support, and parenting time arrangements.
        </p>
      </div>
      ...
      <Card className="border-slate-200 shadow-lg overflow-hidden">
        <CardContent className="p-0">
          <NvDivorceWithChildrenChatInterface caseId={caseId} />
        </CardContent>
      </Card>
...
export default function NvDivorceWithChildrenChatPage() {
  return (
    <Suspense
      fallback={
    ...
    >
      <NvDivorceWithChildrenChatContent />
    </Suspense>
  );
}
