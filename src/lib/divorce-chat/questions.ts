...
export const DIVORCE_CHAT_QUESTIONS: ChatQuestion[] = [
  ...
  },
  {
    ...
    type: 'text',
    question: 'What county and state were you married in?',
    description: 'This will appear in your petition as: "The parties were married in [County], State of [State]."',
    placeholder: 'e.g., Maricopa County, Arizona',
    tooltip: 'The location of your marriage is required for the petition. Please enter the county and state (e.g., "Maricopa County, Arizona").',
    required: true,
  ...
  },
  {
    ...
    required: true,
    nextQuestionId: 'spouse_ssn_known',
  },
  {
    id: 'spouse_ssn_known',
    type: 'yesno',
    question: "Do you know the last 4 digits of your spouse's Social Security number?",
    tooltip: 'If known, this helps identify your spouse in court records. If you don\'t know it, we will note that on the filing.',
    required: true,
    nextQuestionMap: {
      'yes': 'spouse_ssn4',
      'no': 'spouse_phone_known',
    },
  },
  {
    id: 'spouse_ssn4',
    ...
    placeholder: '5678',
    tooltip: 'This helps identify your spouse in court records.',
    required: true,
    nextQuestionId: 'spouse_phone_known',
  },
  {
    id: 'spouse_phone_known',
    type: 'yesno',
    question: "Do you know your spouse's phone number?",
    tooltip: 'A phone number can help facilitate communication regarding the case.',
    required: true,
    nextQuestionMap: {
      'yes': 'spouse_phone',
      'no': 'spouse_email_known',
    },
  },
  {
    id: 'spouse_phone',
    ...
    required: true,
    nextQuestionId: 'spouse_email_known',
  },
  {
  ...
  },
  {
    id: 'military_who',
    type: 'select',
    question: 'Who is in the armed forces?',
    options: [
      { value: 'me', label: 'I am (Petitioner)' },
      { value: 'spouse', label: 'My spouse (Respondent)' },
    ],
    tooltip: 'This determines how military service information will appear in your petition.',
    required: true,
    nextQuestionId: 'military_deployed',
  },
  {
    id: 'military_deployed',
    type: 'yesno',
    question: 'Are you currently deployed?',
    required: true,
    nextQuestionMap: {
  ...
  },
  {
    id: 'other_orders',
    type: 'textarea',
    question: 'Please describe any additional requests here.',
    ...
    tooltip: 'Be as specific as possible about what you are requesting from the court.',
    required: true,
