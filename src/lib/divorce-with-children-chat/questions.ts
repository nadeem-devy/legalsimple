...
export const DIVORCE_WITH_CHILDREN_QUESTIONS: ChatQuestion[] = [
  ...
  // =====================
  {
    id: 'welcome',
    type: 'info',
    question: "Welcome to the Legal QuickFile Wizard for Petition for Dissolution of Marriage WITH CHILDREN. I'll guide you through the process step by step.",
  ...
  },
  {
    ...
    placeholder: 'e.g., I have paid $500 per month directly to my spouse since June 2024...',
