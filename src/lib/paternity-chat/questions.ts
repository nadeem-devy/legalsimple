...
export const PATERNITY_QUESTIONS: ChatQuestion[] = [
  ...
  // =====================
  {
    id: 'welcome',
    type: 'info',
    question: "Welcome to the Legal QuickFile Wizard for Petition to Establish Paternity, Legal Decision Making, Parenting Time and Child Support. I'll guide you through the process step by step.",
  ...
  // =====================
  {
    ...
    type: 'select',
    question: 'Are you or your significant other the biological father of the child?',
    options: [
      { value: 'me', label: 'I am the biological father' },
      { value: 'significant_other', label: 'My significant other is the biological father' },
    ],
  ...
  },
  {
    ...
    required: true,
    nextQuestionId: 'other_party_mailing_address',
  },
  {
  ...
  },
  {
    ...
    required: true,
    nextQuestionId: 'children_current_address',
  },

  // =====================
  // CHILDREN'S RESIDENCE (NEW)
  // =====================
  {
    id: 'children_current_address',
    type: 'address',
    question: 'What is the current address where the child/children reside?',
    placeholder: '123 Main Street, Phoenix, AZ 85001',
  ...
  },
  {
    ...
    required: true,
    nextQuestionMap: {
      'yes': 'voluntary_support_details',
      'no': 'prior_custody_cases_check',
    },
  },
  {
    id: 'voluntary_support_details',
    type: 'textarea',
    question: 'Please describe the voluntary child support payments that have been made:',
    placeholder: 'e.g., I have paid $500 per month directly to my significant other since June 2024...',
    tooltip: 'Include dates, amounts, and how payments were made.',
    required: true,
  ...
  },
  {
    ...
    nextQuestionMap: {
      ...
      'joint_despite_violence': 'drug_conviction_check',
    },
  },
  {
  ...
  },
  {
    ...
    placeholder: 'e.g., Every other weekend Friday 6pm to Sunday 6pm, plus Wednesday evenings 4pm-8pm...',
    tooltip: 'Be as specific as possible about days, times, and pickup/dropoff locations.',
    required: true,
  ...
  },
  {
    ...
    type: 'textarea',
    question: 'Please describe how you would like the summer break schedule to differ from the regular schedule:',
  ...
  // =====================
  {
    ...
    nextQuestionMap: {
      ...
      'custom': 'phone_contact_custom',
    },
  },
  {
    id: 'phone_contact_custom',
    type: 'textarea',
    question: 'Please describe your desired phone/video contact schedule:',
    placeholder: 'e.g., Daily video call between 7pm and 8pm...',
    required: true,
